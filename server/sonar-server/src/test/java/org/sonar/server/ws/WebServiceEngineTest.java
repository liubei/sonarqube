...
public class WebServiceEngineTest {
  ...
  public void execute_request() {
    ...
    underTest.execute(request, response, "api/system", "health");
  ...
  public void bad_request_if_action_suffix_is_not_supported() {
    ...
    assertThat(response.stream().outputAsString()).isEqualTo("{\"errors\":[{\"msg\":\"Unknown action suffix: bat\"}]}");
  }
  ...
  public void no_content() {
    ValidatingRequest request = new SimpleRequest("GET");
    ServletResponse response = new ServletResponse();
    underTest.execute(request, response, "api/system", "alive");
  ...
  public void bad_controller() {
    ValidatingRequest request = new SimpleRequest("GET");
    ServletResponse response = new ServletResponse();
    underTest.execute(request, response, "api/xxx", "health");
  ...
  public void bad_action() {
    ValidatingRequest request = new SimpleRequest("GET");
    ServletResponse response = new ServletResponse();
    underTest.execute(request, response, "api/system", "xxx");
  ...
  public void method_get_not_allowed() {
    ValidatingRequest request = new SimpleRequest("GET");
    ServletResponse response = new ServletResponse();
    underTest.execute(request, response, "api/system", "ping");
  ...
  public void unknown_parameter_is_set() {
    ...
    ServletResponse response = new ServletResponse();
    underTest.execute(request, response, "api/system", "fail_with_undeclared_parameter");
  ...
  public void required_parameter_is_not_set() {
    ValidatingRequest request = new SimpleRequest("GET");
    ServletResponse response = new ServletResponse();
    underTest.execute(request, response, "api/system", "print");
  ...
  public void internal_error() {
    ValidatingRequest request = new SimpleRequest("GET");
    ServletResponse response = new ServletResponse();
    underTest.execute(request, response, "api/system", "fail");
  ...
  public void bad_request_with_i18n_message() {
    ...
    underTest.execute(request, response, "api/system", "fail_with_i18n_message");
  ...
  public void bad_request_with_multiple_messages() {
    ...
    underTest.execute(request, response, "api/system", "fail_with_multiple_messages");
  ...
  public void bad_request_with_multiple_i18n_messages() {
    ...
    underTest.execute(request, response, "api/system", "fail_with_multiple_i18n_messages");
